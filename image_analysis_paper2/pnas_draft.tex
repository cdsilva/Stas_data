...
%
We found that the results are not particularly sensitive to either of these parameters %(5$^{\circ}$--15$^{\circ}$ angle discretizations and kernel scales on the order of the median pairwise distances all yielded acceptable results)
