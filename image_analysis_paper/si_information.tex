...
For the images shown in Figure~3 of the paper, we only use the red and green channels (dpERK and Dl) to register the images.

For the images shown in Figure~4 of the paper, we use all three channels (dpERK, Twi, and nuclei) to register the images.
%
We blur the nuclei using a disc filter with radius $5$~pixels.
%
We also adjust the intensity of the nuclear signal such that 1\% of the pixels are saturated.
