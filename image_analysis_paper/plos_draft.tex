...
\includegraphics[width=0.07\textwidth, trim=6in 0in 6in 0in, clip]{dpERK_vdm_\n}
\hfill}
\caption{}
\end{subfigure}
...
\begin{subfigure}{\textwidth}
\foreach \n in {1,9,17,25,30,34,38,43,49}{
\includegraphics[width=0.07\textwidth, trim=6in 0in 6in 0in, clip]{dpERK_scat_\n}
\hfill}
\caption{}
\end{subfigure}
\caption{{\bf Ordering two-dimensional fluorescent images of dpERK.}
...
\begin{subfigure}{\textwidth}
\foreach \n in {1,9,17,25,30,34,38,43,49}{
\includegraphics[width=0.07\textwidth, trim=6in 0in 6in 0in, clip]{membrane_scat_\n}
\hfill}
\newline
\foreach \n in {1,9,17,25,30,34,38,43,49}{
\includegraphics[width=0.07\textwidth, trim=6in 0in 6in 0in, clip]{membrane_scat_raw_\n}
\hfill}
\caption{}
\end{subfigure}
