...
\usepackage[margin=0in, paperwidth=8.7cm, paperheight=17cm]{geometry}
...
\end{tikzpicture}\\
\begin{tikzpicture}
	\node at (0cm, 0cm) {\includegraphics[width=8cm]{data3_embed_color}};
	\node at (-4cm, 2.5cm) {\textsf{B}};
	%\draw[help lines,step=.5] (-4,-4) grid (4,4);
	\draw [draw=black!20!green, ->, ultra thick] (-2, -2) .. controls (-1.1, 0.2) and  (1, 0)  .. (2, -2);
	\draw [blue, ->, ultra thick] (-2.65, -1.8)  .. controls (-2.3, 0.9) and (-1.7, 1.5) .. (-1.4, 2.1); 
\end{tikzpicture}\\
\begin{tikzpicture}
