...
%
The embryos were fixed and stained with chemicals that visualize nuclei (shown in gray) as well as the spatial distributions of two different proteins (shown in green and red). 
%
...
\customlabel{subfig:membrane_dist}{\ref{fig:membrane_compare}c}
\customlabel{subfig:1d_membranes}{\ref{fig:membrane_compare}d}
\customlabel{subfig:1d_vdm}{\ref{fig:membrane_compare}e}
\end{figure}
