...
\caption{{\it (A)} Fluorescent images of {\it Drosophila} embryos. Each embryo has been stained for Dorsal (green) and dpERK (red). {\it (B)} Selected image from data set. {\it (C)} Profile of Dorsal (green) and dpERK (red) around the circumference of the embryo in {\it B}. }
%\label{fig:images_unordered}
\customlabel{fig:images_unordered}{2}
\customlabel{subfig:images_unordered}{\ref{fig:images_unordered}{\it A}}
\customlabel{subfig:one_image}{\ref{fig:images_unordered}{\it B}}
\customlabel{subfig:image_profiles}{\ref{fig:images_unordered}{\it C}}
\end{figure}
