...
For this data, the quality of the temporal ordering provided by vector diffusion maps can be assessed by comparing with the ordering obtained through an independent approach.
%
...
%
These images cover a thirty minute time interval spanning late cellularization through gastrulation, when the arrangement of newly formed cells begins to deform into structures which will form the future organs \cite{leptin2005gastrulation}.
%
...
%
Clearly, the two branches in the embedding help distinguish the two genotypes.
%
...
We used vector diffusion maps to analyze three different experimental data sets, collected specifically for this study. 
%
...
%
{\color{red} For these applications, vector diffusion maps is essential, as global registration of the entire imaging data set is topologically impossible \cite{zhao2014rotationally}.}
%
{\color{red} In addition, we believe that algorithms based on rotation- and translation-invariant image features which are stable to small deformations, such as the scattering transform \cite{mallat2012group} or the bispectrum and steerable PCA \cite{zhao2014rotationally}, are especially promising; such methods circumvent the need for registration by using invariant features of the images in the data analysis.}
%
