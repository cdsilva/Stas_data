...
%
The translations are done by shifting the pixels, and taking the missing pixels at the edges of the image to be black; we only consider shifts that correspond to an integer number of pixels, to remove the need for interpolation when doing the translations. 
%
